...
export interface PrescriptionTemplate {
   ...
   *  the doctor's name. Optional. */
  doctorCredentials?: string
  /** Free text printed at the bottom of every prescription. */
  footerNote?: string
  /** Compressed logo image as a data URL. Used both as a faint centered
   *  watermark behind the content and as a small icon in the letterhead
   *  header — one upload, no separate header-logo field. Optional — no
   *  logo means neither, not a placeholder. */
  logoDataUrl?: string
}
